...
@Component({
  selector: 'app-add-user-positions',
  templateUrl: './add-user-positions.component.html',
  styleUrls: ['./add-user-positions.component.scss']
})

export class AddUserPositionsComponent implements OnInit {
